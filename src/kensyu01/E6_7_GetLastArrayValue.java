...
public class E6_7_GetLastArrayValue {
	...
	public static final String MESSAGE_OUTPUT_ALL = "配列の全要素の値を出力します";
	// 末尾の値を出力する旨のメッセージのフォーマットを設定する
	public static final String FORMAT_OUTPUT_LAST = "配列の末尾の値は %d です";
	...
	public static final String LAST_OUTPUT = "}";
	// 乱数の範囲を設定する
	public static final int RANGE_RANDOM = 10;
	// 配列の末尾のインデックスを取得するための値を設定する
	public static final int SHIFT_LAST_INDEX = -1;
	...
	public static void main(String[] arg) {
		...
		// 入力された要素数を保持する
		arrayLength = lengthInput.nextInt();
		// 保持した要素数から配列を作成する
