...
public class E5_1_Cardinal_Comverter {
	...
	// 処理内容を示すメッセージを設定する
	private static final String MESSAGE_PROCESSING = "入力した値を8進数、16進数で表示します。";
	// 整数値の入力を求めるメッセージを設定する
	private static final String MESSAGE_REQEST_INPUT = "整数値を入力してください";
	// 入力された値を8進数で表示することをメッセージで出力する
	private static final String MESSAGE_OUT_OCTAL = "8進数 => : ";
	// 入力された値を16進数で表示することをメッセージで出力する
	private static final String MESSAGE_OUT_HEXADECIMAL = "16進数 => : ";
	...
	public static void main(String[] arg) {
		...
		Scanner scannerConvertOperand = new Scanner(System.in);
		...
		// 入力された値を保持する
		integerValue = scannerConvertOperand.nextInt();
		// 入力された値を8進数で表示する
