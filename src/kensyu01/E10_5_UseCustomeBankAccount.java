...
/*** クラス ******************************************/
// 銀行口座クラスを使うクラス
public class E10_5_UseCustomeBankAccount {
	/*** ボブの情報設定 **************************/
	// 名義人「ボブ」を設定する
	...
	public static void main(String[] arg){
		// デフォルト設定のインスタンスを作成する
		CustomBankAccount defaultAccount = new CustomBankAccount();
		// デフォルト設定のインスタンスの情報を確認する
		System.out.println(defaultAccount);

		// 引数を一つ設定したインスタンスを作成する
		CustomBankAccount oneArgumentAccount = new CustomBankAccount(NAME_BOB);
		// 引数を一つ設定したインスタンスの情報を確認する
		System.out.println(oneArgumentAccount);

		// 引数を二つ設定したインスタンスを作成する
		CustomBankAccount twoArgumentAccount = new CustomBankAccount(NAME_MIKE,MIKES_ACCOUNT);
		// 引数を二つ設定したインスタンスの情報を確認する
		System.out.println(twoArgumentAccount);

		// 引数を三つ設定したインスタンスを作成する
		CustomBankAccount threeArgumentAccount = new CustomBankAccount(NAME_ABEL,ABELS_ACCOUNT,NUMBER_ABELS_BALANCE);
		// 引数を三つ設定したインスタンスの情報を確認する
		System.out.println(threeArgumentAccount);

		// 引数を四つ設定したインスタンスを作成する
		CustomBankAccount fourArgumentAccount = new CustomBankAccount(NAME_CHERIE,CHERIES_ACCOUNT,NUMBER_CHERIES_BALANCE,DAY_OPENING_ACCOUNT_CHERIE);
